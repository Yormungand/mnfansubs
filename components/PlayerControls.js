...
//backward
    return (
        <View style={[{height: "100%"}]}>
            <View style={{zIndex: 2, height: "100%", justifyContent: "center", alignItems: "center"}}>
                ...
                <View style={{
                    ...
                    {
                        episodesLength > 0 &&
                        <Pressable style={styles.iconWrapper} onPress={() => showEpisodes(true)}>
                            <Ionicons name="albums" size={36} color="#fff"/>
                        </Pressable>
                    }
                </View>

                <Pressable style={[styles.iconWrapper, {backgroundColor: "rgba(0,0,0,.8)"}]}
                           onPress={state === 'Buffering' ? null : togglePlay}>
                    {renderIcon()}
                </Pressable>
                <View style={[styles.container, {zIndex: 2, marginTop: "auto"}]}>
